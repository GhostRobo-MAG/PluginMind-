    ...
    <div className="space-y-6">
      ...
      <Card className="bg-crypto-dark/50 border-crypto-accent/20">
        <CardHeader>
          <CardTitle className="text-white flex items-center">
            <Activity className="w-5 h-5 mr-2 text-crypto-primary" />
            Market Sentiment Analysis
          </CardTitle>
          <CardDescription className="text-crypto-light">Real-time sentiment indicators for {coin}</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-crypto-light text-sm">Fear & Greed</span>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-crypto-light text-sm">Social Sentiment</span>
              ...
              <span className="text-xs text-crypto-light">Positive mentions trending</span>
            </div>

            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-crypto-light text-sm">Whale Activity</span>
              ...
              <span className="text-xs text-crypto-light">Large wallet accumulation</span>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card className="bg-crypto-dark/50 border-crypto-accent/20">
          <CardHeader>
            <CardTitle className="text-white flex items-center">
              <Globe className="w-5 h-5 mr-2 text-crypto-secondary" />
              Network Health
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex justify-between items-center">
              <span className="text-crypto-light">Network Activity</span>
              <div className="flex items-center">
                <Progress value={data.networkActivity} className="w-20 h-2 mr-2" />
                <span className="text-crypto-primary font-semibold">{data.networkActivity}%</span>
              </div>
            </div>

            <div className="flex justify-between items-center">
              <span className="text-crypto-light">Developer Activity</span>
              <div className="flex items-center">
                <Progress value={data.developerActivity} className="w-20 h-2 mr-2" />
                <span className="text-crypto-secondary font-semibold">{data.developerActivity}%</span>
              </div>
            </div>

            <div className="pt-2 border-t border-crypto-accent/20 space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-crypto-light">Active Addresses</span>
                <span className="text-white">{data.keyMetrics.activeAddresses.toLocaleString()}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-crypto-light">Daily Transactions</span>
                <span className="text-white">{(data.keyMetrics.transactionCount / 1000).toFixed(0)}K</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-crypto-light">Staking Ratio</span>
                <span className="text-crypto-primary">{data.keyMetrics.stakingRatio}%</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-crypto-dark/50 border-crypto-accent/20">
          <CardHeader>
            <CardTitle className="text-white flex items-center">
              <Zap className="w-5 h-5 mr-2 text-crypto-accent" />
              Recent News Impact
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            {data.news.map((item, index) => (
              <div key={index} className="flex items-start space-x-3 p-2 bg-crypto-darker/30 rounded">
                <div
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-2 mt-1">
                    ...
                    <Badge className="text-xs bg-crypto-accent/20 text-crypto-accent border-crypto-accent/30">
                      {item.impact} impact
                    </Badge>
                  </div>
                </div>
      ...
      <Card className="bg-crypto-dark/50 border-crypto-accent/20">
        <CardHeader>
          <CardTitle className="text-white flex items-center">
            <Users className="w-5 h-5 mr-2 text-crypto-primary" />
        ...
        <CardContent>
          <div className="flex items-center justify-between mb-4">
            <span className="text-crypto-light">Net Institutional Flow (7d)</span>
            <div className="flex items-center">
          ...
          <div className="bg-crypto-darker/50 rounded-lg p-4">
            <p className="text-crypto-light text-sm leading-relaxed">
